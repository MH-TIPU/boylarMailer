    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Edit Lead Information</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                ...
                                <option value="unsubscribed" {{ (old('status', $lead->status) == 'unsubscribed') ? 'selected' : '' }}>Unsubscribed</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('source') is-invalid @enderror" id="source" name="source">
                                <option value="manual" {{ (old('source', $lead->source) == 'manual') ? 'selected' : '' }}>Manual Entry</option>
                                ...
                                <option value="import" {{ (old('source', $lead->source) == 'import') ? 'selected' : '' }}>Imported</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags" name="tags" 
                                   value="{{ old('tags', is_array($lead->tags) ? implode(', ', $lead->tags) : $lead->tags) }}" 
                            ...
                            @if(!empty($lead->custom_fields) && is_array($lead->custom_fields))
                                @foreach($lead->custom_fields as $key => $value)
                                    <div class="row mb-2 custom-field-row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="custom_fields_values[]" placeholder="Field value" value="{{ $value }}">
                                        </div>
                                        <div class="col-md-1">
